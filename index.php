...
$selectedId = isset($_GET["post"]) ? (int) $_GET["post"] : 1;
$selectedPost = find_post_by_id($posts, $selectedId);
...
<div class="screen">
  ...
  <a
    ...
    href="post_detail.php?id=<?= e($selectedPost["id"]) ?>"
    <?php if ($selectedPost["type"] === "image") : ?>
  ...
  >
    <div class="hero-content">
      <div class="hero-top">
        ...
        <span class="viewer-badge"><?= e($selectedPost["viewers"]) ?> viewing</span>
      </div>
      <div class="hero-bottom">
        ...
        <div class="social-line">
          <span data-lucide="heart"></span><span><?= e($selectedPost["likes"]) ?></span>
          <span data-lucide="message-circle"></span><span><?= e($selectedPost["comments"]) ?></span>
    ...
    <div class="leaderboard">
      <?php foreach ($leaders as $index => $leader) : ?>
        <div class="leader-row">
          <span class="rank"><?= e($index + 1) ?></span>
          <div>
